...
class DonationsTableViewController: UITableViewController, UISearchResultsUpdating {
    var tableData:[Donation] = []
    ...
    override func viewDidLoad() {
        ...
        WebServiceOperations.getAllDonations(token, completionHandler: { [weak self] (success, message, donations) -> Void in
            if success {
                self?.tableData = donations!
